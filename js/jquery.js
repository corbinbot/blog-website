! function(e, t) {
            ...
            return r && !r[b] && (r = xe(r)), i && !i[b] && (i = xe(i, o)), ae(function(o, a, s, u) {
                ...
                if (o) {
                    if (i || e) {
                        ...
                        for (c = v.length; c--;)(d = v[c]) && (l = i ? F(o, d) : f[c]) > -1 && (o[l] = !(a[l] = d))
                    }
    ...
    p.event = {
        ...
        trigger: function(t, n, i, o) {
            ...
            if (u = f = i = i || r, 3 !== i.nodeType && 8 !== i.nodeType && !de.test(m + p.event.triggered) && (m.indexOf(".") > -1 && (v = m.split("."), m = v.shift(), v.sort()), s = m.indexOf(":") < 0 && "on" + m, (t = t[p.expando] ? t : new p.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3, t.namespace = v.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + v.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : p.makeArray(n, [t]), d = p.event.special[m] || {}, o || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                ...
                for (h = 0;
                    (u = g[h++]) && !t.isPropagationStopped();) t.type = h > 1 ? l : d.bindType || m, (a = (p._data(u, "events") || {})[t.type] && p._data(u, "handle")) && a.apply(u, n), (a = s && u[s]) && a.apply && M(u) && (t.result = a.apply(u, n), !1 === t.result && t.preventDefault());
                if (t.type = m, !o && !t.isDefaultPrevented() && (!d._default || !1 === d._default.apply(g.pop(), n)) && M(i) && s && i[m] && !p.isWindow(i)) {
    ...
    e.getComputedStyle ? (Be = function(t) {
        ...
        return "" !== (a = (n = n || Be(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== a || p.contains(e.ownerDocument, e) || (a = p.style(e, t)), n && !d.pixelMarginRight() && Oe.test(a) && Me.test(t) && (r = s.width, i = s.minWidth, o = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = r, s.minWidth = i, s.maxWidth = o), void 0 === a ? a : a + ""
    ...
    function Ze(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)(r = e[a]).style && (o[a] = p._data(r, "olddisplay"), n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && U(r) && (o[a] = p._data(r, "olddisplay", Fe(r.nodeName)))) : (i = U(r), (n && "none" !== n || !i) && p._data(r, "olddisplay", i ? n : p.css(r, "display"))));
    ...
    p.Animation = p.extend(dt, {
            ...
            prefilters: [function(e, t, n) {
                ...
                for (r in n.queue || (null == (s = p._queueHooks(e, "fx")).unqueued && (s.unqueued = 0, u = s.empty.fire, s.empty.fire = function() {
                    ...
                    })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], "inline" === ("none" === (l = p.css(e, "display")) ? p._data(e, "olddisplay") || Fe(e.nodeName) : l) && "none" === p.css(e, "float") && (d.inlineBlockNeedsLayout && "inline" !== Fe(e.nodeName) ? h.zoom = 1 : h.display = "inline-block")), n.overflow && (h.overflow = "hidden", d.shrinkWrapBlocks() || c.always(function() {
