...
function() {
        ...
        function i(i) {
            function r() {
                if (!h) {
                    ...
                    if (a = function() {
                        ...
                        s.appendChild(r);
                        var f = a(r);
                        p = 200 === e(f.width), s.removeChild(r)
                    }
                }
            }
            ...
            return function(t) {
                if (r(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    for (var h = o.isBorderBox = !(!u || !i[u] || "border-box" !== i[u]), f = 0, d = n.length; d > f; f++) {
                        var l = n[f],
                            c = i[l];
                        c = s(t, c);
                        var y = parseFloat(c);
                    ...
                    var m = o.paddingLeft + o.paddingRight,
                        ...
                        I = o.borderLeftWidth + o.borderRightWidth,
                        L = o.borderTopWidth + o.borderBottomWidth,
                        z = h && p,
                        b = e(i.width);
                    !1 !== b && (o.width = b + (z ? 0 : m + I));
                    var x = e(i.height);
                    return !1 !== x && (o.height = x + (z ? 0 : g + L)), o.innerWidth = o.width - (m + I), o.innerHeight = o.height - (g + L), o.outerWidth = o.width + v, o.outerHeight = o.height + _, o
                }
            }
        }
        ...
        function e(t, e, i) {
            ...
            n.prototype._transitionTo = function(t, e) {
                ...
                if (this.setPosition(t, e), !s || this.isTransitioning) {
                    ...
                    a = h.isOriginLeft ? a : -a, u = h.isOriginTop ? u : -u, p.transform = d(a, u), this.transition({
                        to: p,
                        onTransitionEnd: {
    ...
    function(t) {
        ...
        function n(n, p, f, d, l, c) {
            ...
            var m = 0,
                g = {};
            return y.namespace = "outlayer", y.Item = c, y.defaults = {
                containerStyle: {
                    position: "relative"
                },
                isInitLayout: !0,
                ...
                o ? ("string" == typeof o ? i = this.element.querySelector(o) : h(o) && (i = o), this[t] = i ? d(i)[e] : o) : this[t] = 0
                ...
                delete g[o], delete this.element.outlayerGUID, a && a.removeData(this.element, this.constructor.namespace)
            }, y.data = function(t) {
                ...
                }, o.Item.prototype = new c, p(function() {
    ...
    function(t) {
        ...
        function o(t, o, a, u, p) {
            ...
            h.Item = u, h.LayoutMode = p, h.prototype._create = function() {
                ...
                var i;
                t ? (t = e(t), i = this.getItems(t)) : i = this.items, this._getSorters(), this._updateItemsSortData(i)
