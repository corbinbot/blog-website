    ...
    i.extend(l, {
        ...
        _start: function(e) {
            ...
            if (t = (o = i.extend(!0, {}, l.opts, t)).margin, n = o.padding, "number" === i.type(t) && (o.margin = [t, t, t, t]), "number" === i.type(n) && (o.padding = [n, n, n, n]), o.modal && i.extend(!0, o, {
                ...
                }), o.autoSize && (o.autoWidth = o.autoHeight = !0), "auto" === o.width && (o.autoWidth = !0), "auto" === o.height && (o.autoHeight = !0), o.group = l.group, o.index = e, l.coming = o, !1 === l.trigger("beforeLoad")) l.coming = null;
            else {
        ...
        _setDimension: function() {
            var e, t, n, o, a, r, s, c, d, p = l.getViewport(),
                h = 0,
                m = !1,
                y = !1,
                x = (m = l.wrap, l.skin),
            ...
            if (y = u(o), b = u(a), c = o / a, k = u(f(k) ? u(k, "w") - t : k), O = u(f(O) ? u(O, "w") - t : O), C = u(f(C) ? u(C, "h") - n : C), r = O, s = W = u(f(W) ? u(W, "h") - n : W), w.fitToView && (O = Math.min(p.w - t, O), W = Math.min(p.h - n, W)), t = p.w - L, E = p.h - E, w.aspectRatio ? (y > O && (b = u((y = O) / c)), b > W && (y = u((b = W) * c)), y < k && (b = u((y = k) / c)), b < C && (y = u((b = C) * c))) : (y = Math.max(k, Math.min(y, O)), w.autoHeight && "iframe" !== w.type && (v.width(y), b = v.height()), b = Math.max(C, Math.min(b, W))), w.fitToView)
                if (v.width(y).height(b), m.width(y + T), p = m.width(), L = m.height(), w.aspectRatio)
                    for (;
                        (p > t || L > E) && y > k && b > C && !(19 < h++);) b = Math.max(C, Math.min(W, b - 10)), (y = u(b * c)) < k && (b = u((y = k) / c)), y > O && (b = u((y = O) / c)), v.width(y).height(b), m.width(y + T), p = m.width(), L = m.height();
