! function(e) {
    ...
    n = {
        ...
        setItem: function(e, t, n, i, s, o) {
            ...
            return document.cookie = encodeURIComponent(e) + "=" + encodeURIComponent(t) + c + (s ? "; domain=" + s : "") + (i ? "; path=" + i : "") + (o ? "; secure" : ""), !0
        },
        ...
        setDefaultTheme: function() {
            this.$themeCss = e("link[id=" + this.config.defaultThemeId + "]"), this.$themeCss.length && (this.defaultTheme = this.$themeCss.attr("href"))
        },
        resetStyle: function() {
        ...
        checkCookie: function() {
            var e;
            this.config.cookie && this.config.cookie.isManagingLoad && (e = n.getItem(s)) && (newStyle = this.getFullAssetPath(e), this.updateStyle(newStyle), this.defaultTheme = newStyle)
        },
        addHoverEvents: function() {
            var t = this;
            this.$root.find("a").hover(function() {
                var n = e(this).data("theme"),
                    i = t.getFullAssetPath(n);
                t.updateStyle(i)
            }, function() {
                t.resetStyle()
            })
        ...
        addClickEvents: function() {
            ...
            this.$root.find("a").click(function() {
                var i = e(this).data("theme"),
                    o = t.getFullAssetPath(i);
                t.updateStyle(o), t.defaultTheme = o, t.config.cookie && n.setItem(s, i, t.config.cookie.expires)
            })
        }
    }, e.fn.styleSwitcher = function(n) {
        return new t(this, e.extend(!0, i, n))
    }
}(jQuery);